...
import type { BoothConfig, BoothSize, QuoteRequest, OpenFaces, ElementPositions, BoothElements } from './types';
import { DEFAULT_ELEMENTS, EMPTY_POSITIONS, getDefaultPositions } from './types';
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="mb-8 text-center">
        <span className="text-xs font-semibold tracking-widest text-blue-500 uppercase">ASO SYSTEM Booth Designer</span>
